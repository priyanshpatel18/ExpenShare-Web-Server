...
export async function authMibblewareForSocket(socket: CustomSocket, next: (err?: any) => void) {
...
// Router
userRouter
	.get("/notifications", allowOnlyLoggedInUser, controller.getAllNotifications)
	.get("/getAllUsers", allowOnlyLoggedInUser, controller.getAllUsers)
	.get("/getUser", allowOnlyLoggedInUser, controller.getUser)
	.get("/membersdetail/:userId", allowOnlyLoggedInUser, controller.getmembersdetail)
...
transactionRouter
	...
	.put("/update/:transactionId", allowOnlyLoggedInUser, controller.editTransaction)
...
groupRouter
	...
	.get("/getTransaction/:groupTransactionId", allowOnlyLoggedInUser, controller.getGroupTransaction)
